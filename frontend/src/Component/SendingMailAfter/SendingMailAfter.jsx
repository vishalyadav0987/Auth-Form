...
export default function SendingMailAfter({ email }) {
    return (
        <Flex
            minH={'100vh'}
            align={'center'}
            ...
            >
                ...
                <Stack w={'full'}>
                    <Link to={'/sign-in'}>
                        <Flex bg={"#179cf0"}
                            alignItems={"center"} padding={"10px"} justifyContent={"center"} gap={"5px"}>
                            <Box color={"#fff"}><IoIosArrowRoundBack fontSize={"24px"} /></Box>
                            <Box><Text color={"#fff"} fontSize={"md"}>Back to login</Text></Box>
                        </Flex>
                    </Link>
                </Stack>
            </Stack>
